...
namespace Ews.RestExtensions.Client.Proxy
{
    ...
    /// Root operations.
    /// </summary>
    public partial class Root : IServiceOperations<EwsRestGateway>, IRoot
    {
        /// <summary>
        ...
        /// </param>
        public Root(EwsRestGateway client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<ContainerModel>> RetrieveWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Root").ToString();
