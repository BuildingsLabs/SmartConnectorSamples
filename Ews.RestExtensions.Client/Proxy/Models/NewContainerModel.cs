...
namespace Ews.RestExtensions.Client.Proxy.Models
{
    ...
    /// </summary>
    public partial class NewContainerModel
    {
        /// <summary>
        /// Initializes a new instance of the NewContainerModel class.
        /// </summary>
        public NewContainerModel() { }

        /// <summary>
        /// Initializes a new instance of the NewContainerModel class.
        /// </summary>
        public NewContainerModel(string name = default(string), string description = default(string), string type = default(string), string parentId = default(string), string id = default(string))
        {
            Name = name;
