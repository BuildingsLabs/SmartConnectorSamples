...
namespace Ews.RestExtensions.Client.Proxy.Models
{
    ...
    /// </summary>
    public partial class NewValueModel
    {
        /// <summary>
        /// Initializes a new instance of the NewValueModel class.
        /// </summary>
        public NewValueModel() { }

        /// <summary>
        /// Initializes a new instance of the NewValueModel class.
        /// </summary>
        public NewValueModel(string name = default(string), string description = default(string), string type = default(string), string writeable = default(string), string forceable = default(string), string state = default(string), string unit = default(string), string value = default(string), string parentId = default(string), string id = default(string))
        {
            Name = name;
