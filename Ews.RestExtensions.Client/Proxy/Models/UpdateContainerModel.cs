...
namespace Ews.RestExtensions.Client.Proxy.Models
{
    ...
    /// </summary>
    public partial class UpdateContainerModel
    {
        /// <summary>
        /// Initializes a new instance of the UpdateContainerModel class.
        /// </summary>
        public UpdateContainerModel() { }

        /// <summary>
        /// Initializes a new instance of the UpdateContainerModel class.
        /// </summary>
        public UpdateContainerModel(string name = default(string), string description = default(string), string type = default(string), string parentId = default(string), string id = default(string))
        {
            Name = name;
